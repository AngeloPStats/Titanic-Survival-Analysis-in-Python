...
# Dividing or dataset in 85% training & 15% testing
...
# Predicting : Here we will have two changes
# First, we will drop column "name"
# Second, we will get values for column "Sex"
...
####Angelo - Posted in my jithub 3 26 2024